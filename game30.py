...
menu_background_image = "background"
...
# Menü Butonları
buttons = [
    {"text": "Start", "x": 300, "y": 200, "width": 100, "height": 50, "action": start_game},
    {"text": "Music", "x": 300, "y": 260, "width": 100, "height": 50, "action": toggle_music},
    {"text": "Exit", "x": 300, "y": 320, "width": 100, "height": 50, "action": quit_game}
]

def draw_buttons():
    for button in buttons:
        screen.draw.filled_rect(Rect((button["x"], button["y"], button["width"], button["height"])), "blue")
