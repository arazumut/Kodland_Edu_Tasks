...
kutu = Enemy("enemy2", (550, 265), 2)
ari = Enemy("enemy1", (850, 175), 2)
oyun_sonu = False
score = 0

def start_game():
    global game_state, oyun_sonu, score
    game_state = "playing"
    oyun_sonu = False
    score = 0
